  ...
  return (
    <div className="py-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center mb-8 text-white">Live Calls & SOS</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="card text-center bg-white bg-opacity-90 p-6 rounded shadow-lg">
            <h3 className="text-xl font-bold mb-4">Live Sign-to-Sign Calls</h3>
            <p className="mb-4 text-gray-900">Connect with certified interpreters for real-time communication.</p>
          ...
          <div className="card text-center bg-white bg-opacity-90 p-6 rounded shadow-lg">
            ...
            <p className="mb-4 text-gray-900">Quick gesture-based emergency alert for immediate assistance.</p>
