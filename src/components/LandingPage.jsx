...
const LandingPage = () => {
  return (
    <div>
      ...
      {/* Mission Statement */}
      <section className="py-16 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white rounded-lg shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      {/* Quick Links */}
      <section className="py-16 bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 text-gray-900 dark:text-white rounded-lg shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card bg-white bg-opacity-90 dark:bg-gray-800 text-gray-800 dark:text-white text-center p-8">
